...
<head>
	...
	body { background: #fff; color: #000; font: 11px/normal "Menlo", "Consolas", "DejaVu Sans Mono", "Courier", monospace; padding: 25px; }
	pre,code { font: inherit; }
	.token { background: #ebebff; padding: 0 1px; margin: 0 1px; }
	...
	<script type="text/javascript">jQuery(function(){jQuery().tipsy&&$(".token").tipsy({delayIn:0,delayOut:0,fade:!1,fallback:"",gravity:"nw",html:!0,live:!1,offset:0,opacity:1,title:"title",trigger:"hover"})});</script>
</head>
